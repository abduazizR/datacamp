...
ggplot(evals, aes(x= bty_avg, y=age)) + geom_point()
```
...
```{r bty-rels, fig.height=, fig.width=12, message=FALSE, warning=FALSE}
...
m2 = lm(score ~ rank + gender + language + age + cls_perc_eval + 
    cls_students + ethnicity + cls_level + cls_profs + cls_credits + bty_avg, data = evals)
...
m3 = lm(score ~ rank + gender + language + age + cls_perc_eval + 
    cls_students + ethnicity + cls_level + cls_credits + bty_avg, data = evals)
...
m6 = lm(score ~ rank + gender + language + age + cls_perc_eval + 
    cls_students + ethnicity + cls_level + cls_profs + cls_credits , data = evals)
